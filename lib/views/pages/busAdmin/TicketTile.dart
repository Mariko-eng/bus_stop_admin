...
import 'package:bus_stop_develop_admin/views/pages/busAdmin/TicketReAssign.dart';
...
class TicketTile extends StatefulWidget {
  ...
  const TicketTile({Key key, this.user, this.tripTicket}) : super(key: key);
                              ...
                              child: Column(
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: widget.tripTicket.ticketType == "Ordinary" ? Color(0xffE4181D) : Color(0xffe79200),
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text((widget
                                                        .tripTicket.total / widget.tripTicket
                                                    .numberOfTickets)
                                                        .toString() +
                                                    " SHS"),
                                              ],
