...
import 'package:bus_stop_develop_admin/views/pages/busAdmin/BusParkLocationsMapNew.dart';
...
class BusParkLocationsNew extends StatefulWidget {
  final AdminUserModel user;
  const BusParkLocationsNew({Key key, this.user}) : super(key: key);

  @override
  _BusParkLocationsNewState createState() => _BusParkLocationsNewState();
}

class _BusParkLocationsNewState extends State<BusParkLocationsNew> {
