...
class TripsViewEdit extends StatefulWidget {
  ...
  const TripsViewEdit({Key key, this.user, this.trip}) : super(key: key);
...
class _TripsViewEditState extends State<TripsViewEdit> {
  ...
  void initState() {
    super.initState();
    setState(() {
      _arrivalController.text = widget.trip.arrival['name'];
      _arrivalIdController.text = widget.trip.arrival['id'];
      _departureController.text = widget.trip.departure['name'];
      _departureIdController.text = widget.trip.departure['id'];
      ...
      _totalSeatsController.text = widget.trip.totalSeats.toString();
