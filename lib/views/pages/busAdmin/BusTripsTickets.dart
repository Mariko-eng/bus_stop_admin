...
class BusCompanyTripsTickets extends StatefulWidget {
  ...
  final Trip trip;
  const BusCompanyTripsTickets({Key key,this.user,this.trip}) : super(key: key);
...
class _MyTicketsState extends State<BusCompanyTripsTickets> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<List<TripTicket>>.value(
      ...
      child : TicketList(user: widget.user,trip: widget.trip,),
    );
  }
}
...
class TicketList extends StatefulWidget {
  final AdminUserModel user;
  final Trip trip;
  const TicketList({Key key, this.user,this.trip}) : super(key: key);
