...
import 'package:bus_stop_develop_admin/views/pages/superAdmin/AllDestiantionsViewEdit.dart';
import 'package:bus_stop_develop_admin/views/pages/superAdmin/AllDestinationsNew.dart';
...
class _DestinationListState extends State<AllDestinationsList> {
  ...
  void _openBottomSheet({ Destination destination }) {
  ...
  Widget _getDestOptions({ Destination destination }) {
    final options = [
      "View Bus Trips",
          ...
          onTap: () => {
            ...
            if(option == "View/Edit Destination"){
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          AllDestinationsViewEdit(destination: destination,)
                  ))
            },
          },
          title: Column(
