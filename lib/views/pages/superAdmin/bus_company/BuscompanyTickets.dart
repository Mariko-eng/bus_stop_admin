...
class BusCompanyTickets extends StatefulWidget {
  ...
  const BusCompanyTickets({Key key, this.company}) : super(key: key);
      ...
      body: StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasData) {
            ...
            if(tickets.isEmpty){
              return Center(
                child: Text("No Available Tickets!".toUpperCase(),
...
class AllTicketsTile extends StatefulWidget {
  ...
  const AllTicketsTile({Key key, this.tripTicket})
      : super(key: key);
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        dateToTime(widget.tripTicket.trip.arrivalTime)),
                                  ],
                                ),
                              ),
                            ),
