...
class BusCompanyViewEdit extends StatefulWidget {
  ...
  const BusCompanyViewEdit({Key key,this.company}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [const Text("Account Email"), Text(widget.company.email)],
              ),
            ),
            SizedBox(
              height: 10,
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [const Text("Phone"), Text(widget.company.phoneNumber)],
              ),
            ),
            const SizedBox(
              height: 10,
            ...
            Padding(
              ...
              GestureDetector(
                onTap: () async{
                  ...
                  DocumentSnapshot doc = await FirebaseFirestore.instance.collection("admin_accounts").doc(widget.company.uid).get();
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(10)),
                  child: Text("View Password".toUpperCase(),
